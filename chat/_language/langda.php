...
$LZLANG["client_ticket_information"] = "Vores kundeservice er lukket. Læg en besked og vi vender tilbage hurtigst muligt.";
...
$LZLANG["client_fill_mandatory_fields"] = "Venligst udfyld de obligatoriske felter.";
$LZLANG["client_your_question"] = "Din forespørgsel";
$LZLANG["client_queue_message"] = "Du er nr.  <!--queue_position-->.  i køen. Forventet ventetid: <!--queue_waiting_time--> minuter(s).";
...
$LZLANG["client_leave_message_short"] = "Læg venligst en besked";
...
$LZLANG["index_adding_server"] = "Tilføj denne LiveZilla Serverprofil";
$LZLANG["index_adding_server_hint"] = "Det er nødvendigt at du har LiveZilla installeret på din pc.";
$LZLANG["index_close"] = "Luk";
$LZLANG["index_not_available"] = "Ikke tilgængelig";
$LZLANG["index_addserver"] = "Tilføj server";
$LZLANG["index_description_install"] = "Du kan installere LiveZilla Operator Client direkte fra denne server. Efter download og installation kan du med det samme forbinde til denne LiveZilla Server. Du kan anmode om login data hos LiveZilla administratoren.";
$LZLANG["index_description_profile"] = "Download server profilen for denne LiveZilla Server. En LiveZilla server profil indeholder al den nødvendige information for at forbinde til den relaterede server.";
